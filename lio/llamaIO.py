...
def LlamaIOWindow():
    ...
    publishModel_btn = cmds.iconTextButton(
        'publishModel_btn',
        fla=0, hlc=[0, 1, 1],
        olc=[0, 0, 0],
        st='iconAndTextVertical',
        i='io_publishModel.svg',
        bgc=buttonColour,
        height=50,
        width=100,
        label='Publish REF',
    ...
    cmds.menuItem(
        label='Advanced',
        c='from lio.io_publishModel import IO_publishModel_window;lio.io_publishModel.IO_publishModel(1)',
        stp='python'
    )
    ...
    publishCam_btn = cmds.iconTextButton(
        ...
        bgc=buttonColour, height=50, width=100, label='Publish Camera',
        c='from lio.io_publishCamera import io_exportCamera_window, runWithUI;lio.io_publishCamera.io_exportCamera(0)',
        stp='python'
    )
    ...
    megaPublish_btn = cmds.iconTextButton(
        'megaPublish_btn', fla=0, st='iconAndTextVertical', i='io_publishModel.svg',
        bgc=buttonColour, height=50, width=100, label='Publish to NEW SCENE',
        c='import io_publishToNewScene;io_publishToNewScene.runExportScripts()',
        stp='python'
    )
    ...
    empty = []
    importAnim_btn = cmds.iconTextButton(
        st='iconAndTextVertical', i='io_importAnim.svg', bgc=buttonColour, height=50,
        width=100, label='Import Anim',
        c='lio.io_importAnimation.importAnimation(0,%s)' % empty)
    importCam_btn = cmds.iconTextButton(
        st='iconAndTextVertical', i='io_importCam.svg', bgc=buttonColour, height=50,
        width=100, label='Import Camera', c='lio.io_importCamera.importCameraDialog()'
    )
    importMat_btn = cmds.iconTextButton(
        st='iconAndTextVertical', i='io_importAnim.svg', bgc=buttonColour, height=50,
        width=100, label='Import Materials',
        c='lio.io_importMaterials.assignMaterials()'
    )
    importAll_btn = cmds.iconTextButton(
        en=False, hlc=[1, 1, 1], st='iconAndTextVertical', i='io_importAnim.svg',
        bgc=buttonColour, height=50, width=100, label='I\'m Feeling Lucky', c=''
    )
